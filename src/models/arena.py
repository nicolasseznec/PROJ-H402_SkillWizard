...
from src.util import Shape, generateItems
...
class Arena:
    def __init__(self, data=None):
        ...
        # self.obstacles = {}  # uuid -> obstacle
        # self.floors = {}  # uuid -> floor
        # self.lights = {}  # uuid -> light
        self.obstacles = []
        self.floors = []
        self.lights = []
    ...
    def loadFromData(self, data):
        ...
        # if "floors" in data:
        #     self.floors = {floor.uuid: floor for floor in generateItems(data["floors"], Floor)}
        # if "obstacles" in data:
        #     self.obstacles = {obstacle.uuid: obstacle for obstacle in generateItems(data["obstacles"], Obstacle)}
        # if "lights" in data:
        #     self.lights = {light.uuid: light for light in generateItems(data["lights"], Light)}
        if "floors" in data:
    ...
    def toJson(self):
        return {
            ...
            # "floors": [f.toJson() for f in self.floors.values()],
            # "obstacles": [o.toJson() for o in self.obstacles.values()],
            # "lights": [li.toJson() for li in self.lights.values()],
